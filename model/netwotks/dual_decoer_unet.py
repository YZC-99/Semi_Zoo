...
from model.compare_modules.ska import SKA_Module
...
class Dual_Decoder_Unet_wFPN_wSKA(SegmentationModel):
    def __init__(
            self,
            encoder_name: str = "resnet34",
            encoder_depth: int = 5,
...
class Dual_Decoder_Unet_wFPN_wDAB(SegmentationModel):
    ...
    def forward(self, x):
        ...
        return masks,masks2
class Dual_Decoder_Unet_wFPN(SegmentationModel):
...
class Dual_Decoder_SR_Unet_woSR_wRTFM(SegmentationModel):
