from model.netwotks.deeplab_base import BaseNet
...
class DeepLabV3Plus(BaseNet):
    def __init__(self, backbone, nclass):
        ...
        low_level_channels = self.encoder.channels[0]
        high_level_channels = self.encoder.channels[-1]
    ...
    def base_forward(self, x):
        ...
        c1, _, _, c4 = self.encoder.base_forward(x)
