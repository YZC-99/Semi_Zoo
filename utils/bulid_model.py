...
from model.netwotks.unet import Unet_wASPP_wFPN_wDeocderAttention,Unet_wMSFE_wFPN_wDeocderAttention,Unet_wASPPv2_wFPN_wDeocderAttention
from model.netwotks.unet import Dual_Unet_wASPPv2_wFPN_wDeocderAttention,Dual_Unet_wMSFE_wASPPv2_wFPN_wDeocderAttention
...
from model.netwotks.sr_unet import Unet_wPyramidAttentionASPP_wMain,Unet_wMSFE_wPyramidAttentionASPP_wMain,Dual_Decoder_Unet_wMSFE_wPyramidAttentionASPP_wMain
...
def build_model(args,model,backbone,in_chns,class_num1,class_num2,fuse_type,ckpt_weight=None):
    ...
    elif model == "Unet_wPyramidASPP_wMain":
        net = Unet_wPyramidASPP_wMain(
            encoder_name=backbone,
            encoder_weights='imagenet',
            in_channels=in_chns,
            classes=class_num1,
    ...
    elif model == "Unet_wMSFE_wPyramidAttentionASPP_wMain":
        net = Unet_wMSFE_wPyramidAttentionASPP_wMain(
            encoder_name=backbone,
            encoder_weights='imagenet',
            in_channels=in_chns,
            classes=class_num1,
    ...
    elif model == "Unet_ASPPinBotv2":
        net = Unet_ASPPinBotv2(
            encoder_name=backbone,
            encoder_weights='imagenet',
            in_channels=in_chns,
            classes=class_num1,
    ...
    elif model == "Unet_wPyramidASPP_wMain_ASPPinBot":
        net = Unet_wPyramidASPP_wMain_ASPPinBot(
            encoder_name=backbone,
            encoder_weights='imagenet',
            in_channels=in_chns,
            classes=class_num1,
    ...
    elif model == "Dual_Decoder_Unet_wMSFE_wPyramidAttentionASPP_wMain":
        net = Dual_Decoder_Unet_wMSFE_wPyramidAttentionASPP_wMain(
            encoder_name=backbone,
            encoder_weights='imagenet',
            in_channels=in_chns,
            classes=class_num1,
    ...
    elif model == "Dual_Decoder_Unet_wAuxInPyramidASPP_wMain":
        net = Dual_Decoder_Unet_wAuxInPyramidASPP_wMain(
            encoder_name=backbone,
            encoder_weights='imagenet',
            in_channels=in_chns,
            classes=class_num1,
    ...
    elif model == "Dual_Decoder_Unet_wFPN_wAuxInPyramidASPP_wMain":
        net = Dual_Decoder_Unet_wFPN_wAuxInPyramidASPP_wMain(
            encoder_name=backbone,
            encoder_weights='imagenet',
            in_channels=in_chns,
            classes=class_num1,
    ...
    elif model == "Unet_wMSFE_wFPN_wDeocderAttention":
        net = Unet_wMSFE_wFPN_wDeocderAttention(
            encoder_name=backbone,
            encoder_weights='imagenet',
            in_channels=in_chns,
            classes=class_num1,
    ...
    elif model == "Unet_wASPPv2_wFPN_wDeocderAttention":
        net = Unet_wASPPv2_wFPN_wDeocderAttention(
            encoder_name=backbone,
            encoder_weights='imagenet',
            in_channels=in_chns,
            classes=class_num1,
    ...
    elif model == "Dual_Unet_wASPPv2_wFPN_wDeocderAttention":
        net = Dual_Unet_wASPPv2_wFPN_wDeocderAttention(
            encoder_name=backbone,
            encoder_weights='imagenet',
            in_channels=in_chns,
            classes=class_num1,
    ...
    elif model == "Dual_Unet_wMSFE_wASPPv2_wFPN_wDeocderAttention":
        net = Dual_Unet_wMSFE_wASPPv2_wFPN_wDeocderAttention(
            encoder_name=backbone,
            encoder_weights='imagenet',
            in_channels=in_chns,
            classes=class_num1,
