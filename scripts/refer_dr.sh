...
python test_idrid_supervised_2d_smp.py \
        ...
        --autodl \
        --fpn_out_c 256 \
        --ckpt_weight /root/autodl-tmp/Semi_Zoo/exp_2d_dr/crop_IDRID/Unet_wFPN/lr6e-4_poly-v2-interval-30/imgz1440_mobileone_s0/bs2_Adam_CLAHE0-5k/version02/best_AUC_PR_EX_0.8118_iter_3402.pth \
