...
parser.add_argument('--total_num',type=int,default=10449,help="SEG:2059;SEG_add_DDR:10449")
...
if __name__ == '__main__':
    ...
    labeled_dataset = SemiDataset(name='./dataset/{}'.format(args.dataset_name),
                                  ...
                                  id_path='train_addDDR.txt',h5_file = args.h5_file)
    ...
    val_dataset = SemiDataset(name='./dataset/{}'.format(args.dataset_name),
                                  ...
                                  root="/home/gu721/yzc/data/odoc",
                                  mode='val',
                                  size=args.image_size,h5_file=args.h5_file)
